...
var app = (function () {
    ...
    /* src/modal.svelte generated by Svelte v3.49.0 */
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "svelte-11g0cp4");
    			toggle_class(div0, "modal-background", /*modalActive*/ ctx[0] === true);
    			add_location(div0, file$1, 10, 1, 167);
    			add_location(hr0, file$1, 24, 2, 507);
    			add_location(hr1, file$1, 26, 2, 545);
    			attr_dev(div1, "class", "modal svelte-11g0cp4");
    			attr_dev(div1, "role", "dialog");
    			attr_dev(div1, "aria-modal", "true");
    			add_location(div1, file$1, 17, 1, 335);
    			button.autofocus = true;
    			attr_dev(button, "class", "svelte-11g0cp4");
    			add_location(button, file$1, 29, 1, 560);
    		},
    ...
    function create_content_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(b, file, 11, 14, 231);
    			attr_dev(p, "slot", "content");
    			add_location(p, file, 10, 1, 198);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	function modal0_modalActive_binding(value) {
    		/*modal0_modalActive_binding*/ ctx[2](value);
    	}
    	...
    	function modal1_modalActive_binding(value) {
    		/*modal1_modalActive_binding*/ ctx[3](value);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			p0 = element("p");
    			t6 = text("modalActive1: ");
    			t7 = text(/*modalActive1*/ ctx[0]);
    			t8 = space();
    			p1 = element("p");
    			t9 = text("modalActive2: ");
    			t10 = text(/*modalActive2*/ ctx[1]);
    			add_location(button0, file, 24, 0, 415);
    			add_location(button1, file, 28, 0, 485);
    			add_location(p0, file, 33, 1, 562);
    			add_location(p1, file, 34, 1, 599);
    			add_location(div, file, 32, 0, 555);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*modalActive1*/ 1) set_data_dev(t7, /*modalActive1*/ ctx[0]);
    			if (!current || dirty & /*modalActive2*/ 2) set_data_dev(t10, /*modalActive2*/ ctx[1]);
    		},
    		i: function intro(local) {
    			if (current) return;
